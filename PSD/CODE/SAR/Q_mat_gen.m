...
switch SAR_type 
    ...
    case 'Global'
            ...
            [Q] = read_qmat('globalQMatrix');%             Qtmf = Q.Qtmf;         Qhmf = Q.Qhmf;             Qemf = Q.Qemf;
            ...
            [Qavg_df,Tissue_types,SbRx,Mass_cell,Mass_body]  = gen_Q(dirname,'global','wholebody');%SbR stands for SigmabyRho
