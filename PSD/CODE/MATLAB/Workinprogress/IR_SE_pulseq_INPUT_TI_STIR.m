...
TR=40e-3;                 % input value of TR
T1=15e-3;                 % T1 value of tissue 
j=Ny;
SE=1;
%% calculating the TI based on the tissue T1 value (ref Hand book of MRI pulse sequence)
...
% seq.write('IR_SE_STIR.seq');   % Output sequence for scanner
seq.plot('TimeRange',[0 TR*1e3]);
